...
function in_pars = InsertParams(Patient_Name)
    ...
    in_pars.text.size.score = 50;            % Integer - Determines the font of the text size announcing the total score
    in_pars.text.size.prizes = 40;
    in_pars.text.size.target = 100;

    %in_pars.target - Determines the parameters of the targets
    in_pars.target.radius = 700;                              % Integer - The radius of the target circles 
    ...
    in_pars.player.speed_percent = 800;                  % Percentage - Determines how fast the player will be. 100 is normal 
    ...
    in_pars.trial.num_reps = 2;                      % Natural Number - Determines the amount of trials that will run
    ...
    in_pars.trial.scores = [50, 75, 100, 150] *1000;%, ...    % Vector of Natural Numbers
                            % 200, 250, 350, 500, ...
                            % 750, 1000] * 1000;
